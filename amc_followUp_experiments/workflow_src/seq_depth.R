...
## file paths
biom_fp <- './new_experiments/data/qiime/filt_table.qza'
lacto_asv_fp <- './new_experiments/data/qiime/lactoOnly_rep_seqs.fasta'
output_fp <- './new_experiments/data/misc/newExp_d15-d3_seq_depth.tsv'

## reading in pre-total sum scaled file 
biom <- read_qza(biom_fp)
biom <- biom$data 
