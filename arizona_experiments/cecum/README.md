...
| Supplemental Figure 2a-c | a: `main_src/bile_acid_comp_redo.Rmd` <br/> b: `main_src/metabolomics.Rmd` <br/> c: `main_src/acetate_propionate_comp_redo.Rmd`                                     | a: `supp_fig2a` <br/> b: `supp_fig2bc` <br/> c: `supp_fig2bc`                                                                                   |
