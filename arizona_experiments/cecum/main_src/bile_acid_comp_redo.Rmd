...
bile_acid_fp <- '../data/misc/v2_proc_bile_acid.tsv'
ratio_ba_fp <- '../data/misc/v2_proc_ratio_bileAcid.tsv'
...
## stats on plot
bileAcid_tox_stat_loc <- list('1' = c('conc_normalized' = 5000,
                                      'conc_score' = 1800),
                              '2' = c('conc_normalized' = 7000,
                                      'conc_score' = 14),
                               '3' = c('conc_normalized' = 0,
                                       'conc_score' = 0))

bileAcid_tox_list <- stat_on_plot(stat_table = bileAcid_tox_stats,
                               wanted_col_list = colnames(bileAcid_tox_stats),
                               product_list = bileAcid_tox_stat_loc,
                               join_col = 'bile_effect_order',
...
## stats on plot
bileAcid_histo_stat_loc <- list('1' = c('conc_normalized' = 3000,
                                        'conc_score' = 5),
                              '2' = c('conc_normalized' = 5000,
                                      'conc_score' = 5.75),
                               '3' = c('conc_normalized' = 4000,
                                       'conc_score' = 4))

bileAcid_histo_list <- stat_on_plot(stat_table = bileAcid_histo_stats,
                               wanted_col_list = colnames(bileAcid_histo_stats),
                               product_list = bileAcid_histo_stat_loc,
                               join_col = 'bile_effect_order',
                               x_col_name = 'conc_normalized',
                               y_col_name = 'conc_score',
