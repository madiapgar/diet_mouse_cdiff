...
# unweighted_FP <- './cecum/data/core_outputs/unweighted_unifrac_pcoa_results.qza'
# weighted_FP <- './cecum/data/core_outputs/weighted_unifrac_pcoa_results.qza'
# faith_pd_FP <- './cecum/data/core_outputs/faith_pd.tsv'
# shannon_FP <- './cecum/data/core_outputs/shannon_entropy.tsv'
