...
y_axis_label <- ggdraw() +
  draw_label('Bile Acid Concentration (pmol/mg) (log10)',
             size = 20,
             hjust = 0.5,
             y = 1)
...
all_bileAcid_plotsWithlab <- plot_grid(all_bileAcid_plots,
                                     y_axis_label,
                                     ncol = 1,
...
all_bileAcid_plotsWithlab
```

**Saving my outputs**
```{r}
ggsave('../plots/supp_bileAcid_comp_plot.pdf',
       plot = all_bileAcid_plotsWithlab,
       width = 19,
       height = 10)
```
