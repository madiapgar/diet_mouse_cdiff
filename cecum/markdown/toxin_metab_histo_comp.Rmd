...
comp_plot <- function(compiled_table,
...
## neat cecum
neat_histo_cecum_plot <- comp_plot(histo_neat_toxin,
                                   'neat_conc_norm',
                                   'tissue',
                                   'cecum',
                                   'neat_toxin',
...
## mini neat cecum
mini_neat_histo_cecum_plot <- comp_plot(mini_histo_neat_toxin,
                                         'neat_conc_norm',
                                         'tissue',
                                         'cecum',
                                         'neat_toxin',
...
## neat colon
neat_histo_colon_plot <- comp_plot(histo_neat_toxin,
                                   'neat_conc_norm',
                                   'tissue',
                                   'colon',
                                   'neat_toxin',
...
## cecum 
histo_metabCecum_plot <- comp_plot(histo_metab,
                                   'metab_conc_norm',
                                   'tissue',
                                   'cecum',
                                   'metabolite',
...
## colon
histo_metabColon_plot <- comp_plot(histo_metab,
                                   'metab_conc_norm',
                                   'tissue',
                                   'colon',
                                   'metabolite',
