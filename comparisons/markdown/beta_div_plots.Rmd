...
pcoa_plot <- function(biom_file,
  ...
  biom_file %>% 
    ...
    geom_point(aes(fill = study), pch = 21, alpha = 0.7, size = 2) +
    theme_bw(base_size = 16) +
    scale_fill_brewer(palette = 'Dark2', name = 'Replicate') +
...
uw_title <- 'Combined Unweighted UniFrac PCoA Plot'
...
w_title <- 'Combined Weighted UniFrac PCoA Plot'
...
**Saving my Outputs**
```{r}
ggsave('../day3_filt_plots/unweighted_unifrac_pcoa.pdf',
       plot = filt_unweighted_pcoa, 
       width = 13, 
       height = 7)

ggsave('../day3_filt_plots/weighted_unifrac_pcoa.pdf',
