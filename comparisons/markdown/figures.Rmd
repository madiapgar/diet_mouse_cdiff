...
weighted_by_day <- na.omit(weighted_by_day)

my_table_theme <- gridExtra::ttheme_default(core=list(bg_params = list(fill = 'white', col='black')))
weighted_top <- weighted_pcoa + gridExtra::tableGrob(weighted_by_day,
                                                     rows = NULL, 
                                                     theme = my_table_theme)
                    
fig5_top_row <- plot_grid(weighted_top,
                          nrow = 1,
                          # rel_widths = c(1, 0.5),
                          labels = c('a)'),
                          label_size = 20,
