...
Study (batch) 6 has significantly lower amounts of C. diff toxin in the high-fat/low-fiber diet only. This may indicate that there wasn't a successful infection of the high-fat/low-fiber mice in this batch? Also may be skewing the results but you can only really see it in the diluted toxin plots.
