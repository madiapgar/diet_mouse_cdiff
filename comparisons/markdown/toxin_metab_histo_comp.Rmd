...
- to get negative r values - multiply the result by the estimate (given by the full linear model results) (estimate is greater than zero - multiply by one, if not, mulitply by negative one)
- possibly putting my estimate values on x-axis 
- have r value equal to size of the point in geom point 
- need to factor directionality into the stat plots 
...
**File Paths**
```{r}
metadata_FP <- '../data/misc/filt_comp_metadata.tsv'
