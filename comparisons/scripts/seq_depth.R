...
## file paths
biom_fp <- './comparisons/data/qiime/filt_table.qza'
lacto_asv_fp <- './comparisons/data/qiime/lactoOnly_rep_seqs.fasta'
output_fp <- './comparisons/data/misc/oldExp_seq_depth.tsv'
