...
fig3_top_row <- plot_grid(hypoxia_dietLocation_plot +
                            theme_bw(base_size = 20) +
...
fig3_middle_row <- plot_grid(hypox_cecumHisto_plot +
                               theme_bw(base_size = 20) +
...
**Revised Figure Three**
```{r, fig.height=6, fig.width=10}
rev_fig3 <- plot_grid(hypoxia_cecum_plot +
                        theme_bw(base_size = 20) +
                        ggtitle('Cecum Hypoxia Between Diets'), 
                      NULL,
                      labels = c('a)', ' '),
...
fig4_top_row <- plot_grid(dca_sep_plot +
                            theme_bw(base_size = 20), 
                          ratio_bile_plot +
                            theme_bw(base_size = 20)+
...
fig4_middle_row <- plot_grid(panelC_fig3_redoWithlab,
                             ncol = 1,
                             labels = c('c)'),
                             label_size = 20,
                             align = c('hv'),
...
fig4_bottom_row <- plot_grid(butyrateOnly_plot +
                               theme_bw(base_size = 20),
...
```{r}
microbeProd_relAbunStats_plot$layers[[5]]$aes_params$size <- 6
```
...
plot_grid(family_abun1, stat_plot1,
          labels = c('a)', 'b)'),
          label_size = 20,
          rel_widths = c(1, 0.9)) -> fig5_top_row
