...
fig4_top_row <- plot_grid(hypoxia_dietLocation_plot +
                            theme_bw(base_size = 20) +
...
fig4_middle_row <- plot_grid(hypox_cecumHisto_plot +
                               theme_bw(base_size = 20) +
...
rev_fig4 <- plot_grid(hypoxia_cecum_plot +
                        theme_bw(base_size = 20) +
                        ggtitle('Cecum Hypoxia Between Diets'), 
                      NULL,
                      labels = c('a)', ' '),
...
```{r}
microbeProd_relAbunStats_plot$layers[[6]]$aes_params$size <- 6
```

```{r, warning=FALSE, fig.height=25, fig.width=35}
plot_grid(family_abun1, stat_plot1,
          labels = c('a)', 'b)'),
          label_size = 20,
          rel_widths = c(1, 0.9)) -> fig6_top_row
...
fig7_bottom_row <- plot_grid(everything_stats, NULL,
                             nrow = 1,
                             rel_widths = c(1, 0.7))

fig7 <- plot_grid(everything_plot,
                  fig7_bottom_row,
                  ncol = 1,
                  labels = c('a)', 'b)'),
                  label_size = 20,
...
```{r, fig.height=8.5, fig.width=27}
fig8 <- plot_grid(miniVendor_genusAbun_plot +
