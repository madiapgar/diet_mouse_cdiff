...
## **Figure Two - REDO ALL STATS IN LOG10!!**
Plots to go in figure:
- cecal toxin plot 
...
## **Figure Three - REDO ALL STATS IN LOG10!!**
Plots to go in figure:
...
plot_grid(genusAbun_plots_together_withLabs,
          ...
          ncol = 1,
          label_size = 20,
          rel_heights = c(1, 0.4)) -> fig6

fig6
```

```{r, fig.height=30, fig.width=29}
fig6_part_two <- plot_grid(lachno_abun_plot +
