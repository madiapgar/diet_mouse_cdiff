...
I'm doing this for an upcoming poster presentation that I would like to do. Putting a pause on this temporarily so I can mess with the formatting with the individual plots. 
```{r, fig.height=7, fig.width=25}
poster_uu_faith <- plot_grid(faith_plot, unweighted_pcoa,
                             ncol = 2,
                             labels = c('A', 'B'),
                             label_size = 22)
poster_uu_faith
...
## composed alpha/beta div figures for poster
# ggsave("poster_uu_faith.pdf",
#        plot = poster_uu_faith,
#        width = 25,
#        height = 7,
#        path = '../plots')
```
