...
fig2_top_row <- plot_grid(neat_plot, all_day_plot,
                          labels = c('a)', 'b)'),
                          rel_widths = c(0.9, 1),
                          align = 'h')

fig2_middle_row <- plot_grid(neat_histo_tca_plot, neat_histo_tcb_plot,
                             labels = c('c)', 'd)'),
                             align = 'h')

fig2_bottom_row <- plot_grid(neat_tox_stat_vis, NULL,
                             nrow = 1,
                             rel_widths = c(0.5, 1),
                             labels = c('e)', ' '))
...
```{r, warning=FALSE, fig.height=13, fig.width=18}
fig4_bottom_row <- plot_grid(histo_acetic_plot, histo_butanoic_plot,
...
```{r, warning=FALSE, fig.width=26, fig.height=16}
