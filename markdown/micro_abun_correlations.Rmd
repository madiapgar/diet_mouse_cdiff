...
asv_diet_labs <- c('High Fat / High Fiber',
                   'High Fat / Low Fiber',
                   'Low Fat / High Fiber',
                   'Low Fat / Low Fiber')
names(asv_diet_labs) <- c('HF/HF',
                          'HF/LF',
                          'LF/HF',
                          'LF/LF')
...
lfc_w_tax %>% 
  ...
  facet_wrap(~diet,
             nrow = 1,
             labeller = labeller(diet = asv_diet_labs)) +
  theme_bw() +
...
histo_lfc %>% 
  ...
  labs(x = NULL,
       y = NULL,
       title = 'Log Fold Changes of Inflammation by Tissue') +
  theme(legend.title = element_blank()) -> histo_lfc_plot
...
ggsave('diet_comp_lfc.pdf',
       ...
       height = 10, 
       path = '../plots')
ggsave('diet_asv_lfc.pdf',
       plot = lfc_tax_plot,
       width = 20, 
       height = 5, 
       path = '../plots')
ggsave('histo_lfc.pdf',
       plot = histo_lfc_plot,
       width = 10, 
       height = 10, 
       path = '../plots')
