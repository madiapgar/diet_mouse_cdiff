...
use surv_fit for each pairwise comparison and then extract the p-values from those. able to compare them that way. take out p-value from plots
...
diet_plot$plot +
    facet_grid(~factor(diet, levels = c('chow',
                                        'HF+fiber',
                                        'HF/LF',
                                        'LF+fiber',
                                        'LF/LF')),
    ...
    scale_fill_viridis(option = 'H', discrete = TRUE) -> diet_plot_final

diet_plot_final
```

**Pairwise Comparisons**\
not sure how to get my significance matrix into a ggplot visualization...
...
diet_pvalue %>%
  ...
  geom_tile(aes(fill = p.value), alpha = 0.6) +
  ...
  scale_x_discrete(labels = c("Chow",
                              ...
                              "High-Fat/\nHigh-Fiber",
                              "Low-Fat/\nLow-Fiber")) +
  scale_y_discrete(labels = c("Low-Fat/\nHigh-fiber",
                              "Low-Fat/\nLow-Fiber",
                              "High-Fat/\nHigh-Fiber",
                              "High-Fat/\nLow-Fiber")) -> surv_stat_vis
