...
stat_file_prep <- function(metadata_fp,
  ...
  stat_biom %>% 
    select(sample, ko, taxon_function_abun, study, diet, day_post_inf, 
         any_of(taxonomy_level), purified_diet, high_fat, high_fiber, mouse_id, seq_depth) %>% 
    ...
    gather(-ko, -sample, -diet, -purified_diet, -high_fat, -high_fiber, -mouse_id, -seq_depth,
           -.data[[taxonomy_level]], -study, key = day_post_inf, value = taxon_function_abun) -> biom_long
  return(biom_long)
}
