...
```{r}
## unweighted unifrac 
uu_day8_adonis <- adonis_per_day(filt_stat_meta,
                                 -8,
                                 uw_dist_fp,
                                 unwanted_samples)
uu_dayneg3_adonis <- adonis_per_day(filt_stat_meta,
                                    -3,
                                    uw_dist_fp,
                                    unwanted_samples)
uu_day0_adonis <- adonis_per_day(filt_stat_meta,
                                 0,
                                 uw_dist_fp,
                                 unwanted_samples)
uu_day3_adonis <- adonis_per_day(filt_stat_meta,
                                 3,
                                 uw_dist_fp,
                                 unwanted_samples)

## weighted unifrac
w_day8_adonis <- adonis_per_day(filt_stat_meta,
                                 -8,
                                 w_dist_fp,
                                 unwanted_samples)
w_dayneg3_adonis <- adonis_per_day(filt_stat_meta,
                                    -3,
                                    w_dist_fp,
                                    unwanted_samples)
w_day0_adonis <- adonis_per_day(filt_stat_meta,
                                 0,
                                 w_dist_fp,
                                 unwanted_samples)
w_day3_adonis <- adonis_per_day(filt_stat_meta,
                                 3,
                                 w_dist_fp,
                                 unwanted_samples)
```
...
write_tsv(uu_day8_adonis, '../stats/uw_adonis_dayNeg8.tsv')
write_tsv(uu_dayneg3_adonis, '../stats/uw_adonis_dayNeg3.tsv')
write_tsv(uu_day0_adonis, '../stats/uw_adonis_day0.tsv')
write_tsv(uu_day3_adonis, '../stats/uw_adonis_day3.tsv')
write_tsv(w_day8_adonis, '../stats/w_adonis_dayNeg8.tsv')
write_tsv(w_dayneg3_adonis, '../stats/w_adonis_dayNeg3.tsv')
write_tsv(w_day0_adonis, '../stats/w_adonis_day0.tsv')
write_tsv(w_day3_adonis, '../stats/w_adonis_day3.tsv')
```
