...
adonis_test <- function(dist_matrix,
                        metadata_file){
  adonis_results <- adonis2(as.dist(dist_matrix) ~ (purified_diet * seq_depth)
                            + (high_fat * high_fiber) + study,
                            data = metadata_file,
                            permutations = 999, 
                            parallel = 4)
...
TO DO: 
- take out sequencing depth - at least for one run
- take chow/purified diet out and run based on high fat/high fiber
```{r}
