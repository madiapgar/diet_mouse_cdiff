...
otu_FP <- '../data/qiime/otu_table.qza'
...
obAn_day_abun_table <- day_abun_table %>% 
                        filter(Family == 'Lachnospiraceae' | Family == 'Ruminococcaceae' | Family == 'Bacteroidaceae')

facAn_day_abun_table <- day_abun_table %>% 
                          filter(Family == 'Enterobacteriaceae' | Family == 'Enterococcaceae' | 
                                   Family == 'Staphylococcaceae' | Family == 'Lactobacillaceae')
```
