...
**Prep for attempt at using new "pipeline" for Butyrate Kinase Plot**
```{r}
buk_meta_fp <- '~/gut_microbiome_metabolomics/total_sum_scaled/updated/updated_metadata.csv'
buk_taxonomy_fp <- '~/gut_microbiome_metabolomics/total_sum_scaled/tax_info/taxonomy.qza'
buk_ko_contrib_fp <- 
...
**Butyrate Kinase plot construction via pipeline**
...
**Prep for Butryl-CoA Transferase**
```{r}
but_meta_fp <- '~/gut_microbiome_metabolomics/total_sum_scaled/updated/updated_metadata.csv'
but_taxonomy_fp <- '~/gut_microbiome_metabolomics/total_sum_scaled/tax_info/taxonomy.qza'
but_ko_contrib_fp <- 
  '~/gut_microbiome_metabolomics/total_sum_scaled/butyrate_bile_pred_outputs/untrustable_meta_contrib.tsv'
but_tax_level <- 'class'
but_thresh_level <- 50
...
**Butryl-CoA Transferase plot construction via pipeline**
```{r, fig.height=5, fig.width=10, warning=FALSE}
...
**Prep for NEW baiH secondary bile acid plot**
```{r}
bile_meta_fp <- '~/gut_microbiome_metabolomics/total_sum_scaled/updated/updated_metadata.csv'
bile_taxonomy_fp <- '~/gut_microbiome_metabolomics/total_sum_scaled/tax_info/taxonomy.qza'
bile_contrib_fp <- 
  '~/gut_microbiome_metabolomics/total_sum_scaled/butyrate_bile_pred_outputs/untrustable_meta_contrib.tsv'
...
ggsave("tss_buk2.pdf", 
       ...
       width = 15, 
       height = 10,
       path = '~/gut_microbiome_metabolomics/total_sum_scaled/butyrate_bile_pred_outputs')
