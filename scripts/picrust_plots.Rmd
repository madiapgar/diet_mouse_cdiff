...
ko_contrib_prep <- function(ko_contrib_fp, metadata_fp, taxonomy){
...
butyrate_plot <- function(meta_fp, taxonomy_fp, ko_meta_contrib_fp, 
  ...
  ko_biom <- ko_contrib_prep(ko_meta_contrib_fp, meta_fp, ko_taxonomy)
...
total_butyrate_kinase <- butyrate_plot(metadata_FP, 
                                       tax_FP,
                                       ko_contrib_FP, 
                                       buk_tax_level, 
                                       buk_thresh_level, 
...
```{r, fig.height=5, fig.width=10, warning=FALSE}
total_butyrylcoa_transferase <- butyrate_plot(metadata_FP, 
                                              but_taxonomy_fp,
                                              but_ko_contrib_fp, 
                                              but_tax_level,
                                              but_thresh_level, 
...
total_baiH <- other_secondary_bile_acid(metadata_FP, 
                                        bile_taxonomy_fp,
                                        bile_contrib_fp, 
                                        bile_tax_level, 
                                        baiH_ko, 
...
**NEW baiI plot**
```{r, fig.height=6, fig.width=10, warning=FALSE}
total_baiI <- other_secondary_bile_acid(metadata_FP, 
                                        bile_taxonomy_fp,
                                        bile_contrib_fp, 
                                        bile_tax_level,
                                        baiI_ko, 
...
```{r, fig.height=6, fig.width=10, warning=FALSE}
total_bile_acid <- secondary_bile_acid(metadata_FP, 
                                       bile_taxonomy_fp,
                                       bile_contrib_fp, 
                                       bile_tax_level, 
                                       bile_kos, 
...
ggsave("picrust_plots_assembled.pdf",
