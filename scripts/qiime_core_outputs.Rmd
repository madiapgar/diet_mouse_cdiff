...
```{r}
metadata_FP <- 'merged_metadata1.tsv'
...
tss_tax <- read_qza('~/gut_microbiome_metabolomics/total_sum_scaled/tss3/taxonomy.qza')$data %>% 
                    parse_taxonomy() %>% 
...
sample_asv_fp <- '~/gut_microbiome_metabolomics/total_sum_scaled/updated/tss_sample_asv.tsv'
...
## unweighted files 
tss_unweighted <- 
  read_qza('~/gut_microbiome_metabolomics/total_sum_scaled/tss3/tss_core_metrics3/unweighted_unifrac_pcoa_results.qza')$data
##used for stats 
...
faith_pd_fp <- 
  '~/gut_microbiome_metabolomics/total_sum_scaled/tss3/tss_core_metrics3/99697762-4585-43b8-bf9d-92774722b04f/data/alpha-diversity.tsv'
...
## weighted files
tss_weighted <- 
  read_qza('~/gut_microbiome_metabolomics/total_sum_scaled/tss3/tss_core_metrics3/weighted_unifrac_pcoa_results.qza')$data
##used for stats 
