...
sectioned_faith_lm %>% 
  filter(day_post_inf != -15) -> sectioned_faith_lm
...
```{r}
## reading in core output biom table 
biom_fp <- '../data/qiime/core_outputs/rarefied_table.qza'

core_biom <- read_qza(biom_fp)$data
```
