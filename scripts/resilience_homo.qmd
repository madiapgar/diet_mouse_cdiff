...
Unweighted UniFrac Resiliency Calculation

```{r}
uu_dist_filt <- dist_filter(uu_dist,
                            meta,
                            diets)

uu_resil_dist <- resil_dist_comp(uu_dist_filt,
                                 meta)
...
**Weighted UniFrac Resiliency Calculation**

```{r}
wu_dist_filt <- dist_filter(wu_dist,
                            meta,
                            diets)

wu_resil_dist <- resil_dist_comp(wu_dist_filt,
                                 meta)
...
**Homogeneity functions for plot and statistical analysis**
...
## and pulls all unique distance matrix comparisons out for that particular diet 
## and places them in a new column 
## it also compares each day_post_inf to each other, so it looks at the variation within
## each day 
...
**Unweighted/Weighted UniFrac Homogeneity Calculation**
...
uu_dist_filt <- dist_filter(uu_dist,
                            meta,
                            diets)
uu_homog_dist <- homog_dist_comp(uu_dist_filt,
                                 meta)
...
wu_dist_filt <- dist_filter(wu_dist,
                            meta,
                            diets)
wu_homog_dist <- homog_dist_comp(wu_dist_filt,
                                 meta)
